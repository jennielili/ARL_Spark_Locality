...
def trial_case(results, seed=180555, context='wstack', nworkers=8, threads_per_worker=1,
    ...
    #Here we put vis_graph_list and model_graph_list together, thus just one vis_graph_list
    vis_graph_list = create_corrupt_vis_graph_locality(vis_graph_list, phase_error=1.0)
    ...
    start = time.time()
    residual_graph, deconvolve_graph, restore_graph = create_ical_graph_locality(sc, broadcast_tele,vis_graph_list, model_graph, nchan=nfreqwin, context=context, vis_slices=vis_slices,
